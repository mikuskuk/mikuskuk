...
### ✈️ [Flight Planner](https://github.com/mikuskuk/flight-planner)
REST API writen in Java & Spring Boot

### 🦎 [Rock, Paper, Scissors, Lizard, Spock](https://github.com/mikuskuk/Rock-Paper-Scissors-Lizard-Spock)
Classic Rock, Paper, Scissors game with additional features and CPU play.

### 💵 [API Currency Convertor](https://github.com/mikuskuk/Currency-Convertor)
Currency convertor that converts any currency to EUR using currency API.
...
<!--
**mikuskuk/mikuskuk** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
